    ...
    <div className="container">
      ...
      <div className="xl:flex">
        <div className="sm:flex xl:w-1/3 my-8 w-auto">
          <img
            src="/images/samsunTablet.webp"
            alt="samsun tablet"
            className="sm:w-1/2 xl:w-full w-full rounded-xl"
          />
          <img
            src="/images/a34.webp"
            alt="a34"
            className="sm:w-1/2 xl:hidden w-full rounded-xl"
          />
        </div>
        <div className="xl:w-2/3 w-full border-2 border-gray-300 bg-white rounded-xl justify-center md:flex md:items-center md:flex-wrap">
          <img
            src={bigOfferProduct.img}
            alt=""
            className="rounded-md md:w-1/3 "
          />
          <div className="md:w-2/3 text-center p-3 relative">
            <span className="bg-red-600 text-white absolute top-3 left-3 px-2 py-1 rounded-xl text-sm sm:text-[18px]">
              % {discount}
            </span>
            <div className="mb-8">
            ...
            <div>
              <h4 className="text-2xl text-center my-3 text-bold">
                {bigOfferProduct.offerPrice}
              </h4>
              <p className="text-zinc-400 text-sm mt-1 line-through text-center">
                {bigOfferProduct.price}
              </p>
            </div>
            <div className="m-4 grid grid-cols-2 justify-items-center">
              <p className="flex m-2">
                <CheckCircleIcon className="w-5 text-green-500 m-1" /> لورم لورم
                لورم
              </p>
              <p className="flex m-2">
                <CheckCircleIcon className="w-5 text-green-500 m-1" /> لورم لورم
            ...
            <div className="flex mx-auto my-3 justify-center items-center rounded-md p-2 bg-red-100 text-red-600 w-1/4 text-bold">
              <p className="m-1">11</p>:<p className="m-1">22</p>:
              <p className="m-1">33</p>
            </div>
          </div>
        </div>
      </div>
