      ...
      <div className="xl:flex">
        ...
        <div className="xl:w-2/3 w-full border-2 border-gray-300 bg-white rounded-xl justify-center md:flex md:items-center md:flex-wrap">
          ...
          <div className="md:w-2/3 text-center p-3 relative">
            <span className="bg-red-600 text-white absolute top-3 left-3 px-2 py-1 rounded-xl text-sm sm:text-[18px]">% {discount}</span>
            <div className="mb-8">
              <h3 className="text-3xl">{bigOfferProduct.name}</h3>
              <p className="text-zinc-400 text-md">{bigOfferProduct.ename}</p>
            </div>
            <div>
              <h4 className="text-2xl text-center my-3 text-bold">{bigOfferProduct.offerPrice}</h4>
              <p className="text-zinc-400 text-sm mt-1 line-through text-center">{bigOfferProduct.price}</p>
            </div>
            <div className="m-4 grid grid-cols-2 justify-items-center">
              {bigOfferProduct?.propertys?.map((property) => (
                <p className="flex m-2" key={property}>
                  <CheckCircleIcon className="w-5 text-green-500 m-1" /> {property.desc}
                </p>
              ))}
            </div>
