...
export default function Filter() {
  ...
  return (
    <>
      <div className={`w-full h-full transition-all duration-300 bg-white mx-3 p-2 rounded-lg  hidden lg:flex flex-col gap-3 `}>
      ...
      <ModalContainer open={show} setOpen={setShow} className={""}>
