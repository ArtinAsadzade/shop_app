        ...
        <div className="flex flex-wrap">
          <div className="w-full px-4 sm:w-2/3 lg:w-4/12">
            <div className="mx-auto flex flex-wrap">
              <h1 className="mb-2 opacity-90 text-lg">فروشگاه اینترنتی ایران مارکت</h1>
              <p className="mb-7 opacity-60 text-sm">
                ایران مارکت به عنوان یکی از بروزترین فروشگاه های اینترنتی با بیش از هفت سال تجربه، با پایبندی به اعتماد مشتری،
                موفق شده تا با فروشگاه‌های معتبر ایران به یکی از بزرگ‌ترین فروشگاه اینترنتی کشور تبدیل شود. هر آنچه که فکرش را
                بکنید و به ذهن شما خطور می‌کند در اینجا پیدا خواهید کرد.
              </p>
            </div>
          </div>
          <div className="w-full px-4 sm:w-1/2 lg:w-3/12">
            <div className="mb-10 w-full flex flex-col">
              <h1 className="mb-2 opacity-90">لینک های مفید:</h1>
              {links.map((item) => (
                <a
                  href={item.link}
                  key={item.id}
                  className="m-2 text-sm hover:text-red-600 transition opacity-60 hover:opacity-100"
                >
                  {item.title}
                </a>
              ))}
          ...
          <div className="w-full px-4 sm:w-1/2 lg:w-3/12">
            <div className="mb-10 w-full flex flex-col text-sm">
              <h1 className="mb-2 opacity-90">ارتباط با ما:</h1>
              <p className="opacity-60 transition m-2">آدرس: تهران،خیابان دماوند</p>
              <p className="opacity-60 transition m-2">تلفن:09111111111</p>
              <p className="opacity-60 transition m-2">ساعت پاسخگویی:9 الی 18</p>
            </div>
          </div>
          <div className="w-full px-4 sm:w-1/2 lg:w-2/12">
            <div>
              <h1 className="mb-2 text-center opacity-80">شبکه های اجتماعی:</h1>
