  ...
  return (
    <>
      ...
      <div className="w-full h-svh flex bg-gray-200 min-h-full px-6 py-12 lg:px-8">
        <div className="w-full p-8 backdrop-brightness-150 sm:w-1/2 rounded-md mx-2">
          <div className="sm:mx-auto sm:w-full sm:max-w-sm">
            <h2 className="mt-10 text-center text-2xl font-bold leading-9 tracking-tight text-gray-900">
              به حساب کاربری خود وارد شوید{" "}
              <HeartIcon className="w-6 inline-block" />
            </h2>
          </div>
              ...
              <div>
                ...
                <div className="mt-2">
                  <input
                    ...
                    type="text"
                    required
                    className="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 p-4 pl-7 ring-inset ring-red-300 placeholder:text-red-400 focus:ring-2 focus:ring-inset focus:ring-gray-500 sm:text-sm sm:leading-6"
                  />
                </div>
              </div>
              ...
              <div>
                ...
                <div className="mt-3 relative">
                  ...
                  <input
                    ...
                    required
                    className="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-red-300 p-4 pl-7 placeholder:text-red-400 focus:ring-2 focus:ring-inset focus:ring-gray-500 sm:text-sm sm:leading-6 border-none"
                  />
                </div>
              </div>
